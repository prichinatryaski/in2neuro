Если тебе дали ссылку сюда, значит, тебе нужен RAG. RAG это чуть ли не самый популярный запрос среди всех, кто приходит тыкать нейронки, поэтому я собрал тут большую часть инфы, что даёт интернет.
----------
# Что такое RAG?
** Если совсем просто:
